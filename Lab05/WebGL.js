...
var frontViewMatrix1 = new Matrix4();
var frontViewMatrix2 = new Matrix4();
var frontViewMatrix3 = new Matrix4();
...
function main() {
    ...
    frontViewMatrix2.setLookAt(0, 0, -10, 0, 0, 100, 0, 1, 0);
    frontViewMatrix3.setLookAt(0, 0, 10, 0, 0, 0, 0, 1, 0);

    pespProjMatrix1.setPerspective(30, canvas.width / canvas.height, 1, 100);
    pespProjMatrix2.setPerspective(30, canvas.width / (canvas.height / 2), 1, 100);
    orthoProjMatrix.setOrtho(-2, 2, -2, 2, 1, 100);
...
function draw(x, y) {
    ...
    drawOneViewport(gl, canvas.width / 2, 0, canvas.width / 2, canvas.height / 2,
        0.5, 0.5, 0.5,
        orthoProjMatrix, frontViewMatrix1, modelMatrix1, modelMatrix2);
    ...
    drawOneViewport(gl, 0, canvas.height / 2, canvas.width, canvas.height / 2,
        0.8, 0.8, 0.8,
        pespProjMatrix2, frontViewMatrix3, modelMatrix1, modelMatrix2);
}
