...
async function main() {
  ...
  cubeVertices = [
    // Face z = 1.0
    // Front face
    -1.0, -1.0, 1.0,  // F1_T1_V1
    1.0, -1.0, 1.0,   // F1_T1_V2
    1.0, 1.0, 1.0,    // F1_T1_V3
    -1.0, -1.0, 1.0,  // F1_T2_V4
    1.0, 1.0, 1.0,    // F1_T2_V5
    -1.0, 1.0, 1.0,   // F1_T2_V6

    // Face x = 1.0
    // Right face
    1.0, -1.0, 1.0,   // F2_T1_V1
    1.0, -1.0, -1.0,  // F2_T1_V2
    1.0, 1.0, -1.0,   // F2_T1_V3
    1.0, -1.0, 1.0,   // F2_T2_V4
    1.0, 1.0, -1.0,   // F2_T2_V5
    1.0, 1.0, 1.0,    // F2_T2_V6

    // Face y = 1.0
    // Top face
    -1.0, 1.0, 1.0,   // F3_T1_V1
    1.0, 1.0, 1.0,    // F3_T1_V2
    1.0, 1.0, -1.0,   // F3_T1_V3
    -1.0, 1.0, 1.0,   // F3_T2_V4
    1.0, 1.0, -1.0,   // F3_T2_V5
    -1.0, 1.0, -1.0,  // F3_T2_V6

    // Face x = -1.0
    // Left face
    -1.0, -1.0, -1.0,  // F4_T1_V1
    -1.0, -1.0, 1.0,   // F4_T1_V2
    -1.0, 1.0, 1.0,    // F4_T1_V3
    -1.0, -1.0, -1.0,  // F4_T2_V4
    -1.0, 1.0, 1.0,    // F4_T2_V5
    -1.0, 1.0, -1.0,   // F4_T2_V6

    // Face y = -1.0
    // Bottom face
    -1.0, -1.0, -1.0,  // F5_T1_V1
    1.0, -1.0, -1.0,   // F5_T1_V2
    1.0, -1.0, 1.0,    // F5_T1_V3
    -1.0, -1.0, -1.0,  // F5_T2_V4
    1.0, -1.0, 1.0,    // F5_T2_V5
    -1.0, -1.0, 1.0,   // F5_T2_V6

    // Face z = -1.0
    // Back face
    1.0, -1.0, -1.0,   // F6_T1_V1
    -1.0, -1.0, -1.0,  // F6_T1_V2
    -1.0, 1.0, -1.0,   // F6_T1_V3
    1.0, -1.0, -1.0,   // F6_T2_V4
    -1.0, 1.0, -1.0,   // F6_T2_V5
    1.0, 1.0, -1.0     // F6_T2_V6
  ];
...
function draw() {
  ...
  mdlMatrix.scale(2, 0.1, 2); // make the cube look like a ground
  drawOneObject(cube, mdlMatrix, 1.0, 0.4, 0.4);

  //mario
  //TODO-2: set mdlMatrix for mario
  mdlMatrix.setIdentity();
  mdlMatrix.setTranslate(-1, 0.6, -1);
  mdlMatrix.scale(0.008, 0.008, 0.008); // make the mario smaller
  drawOneObject(mario, mdlMatrix, 0.4, 1.0, 0.4);

  //sonic
  //TODO-3: set mdlMatrix for sonic (include rotation and movement)
  mdlMatrix.setIdentity();
  mdlMatrix.setTranslate(0, 0.1, moveDistance);
  mdlMatrix.rotate(rotateAngle, 0, 1, 0);
  mdlMatrix.scale(0.04, 0.04, 0.04); // make the sonic smaller
