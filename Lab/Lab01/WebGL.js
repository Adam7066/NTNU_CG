...
function click(ev, gl, canvas, u_Position, u_FragColor){
    ...
    if(x >= 0.0 && y >= 0.0) g_colors.push([1.0,0.0,0.0, 1.0]) //red
    else if(x < 0.0 && y < 0.0) g_colors.push([0.0,1.0,0.0, 1.0]) //green
    else if(x >= 0.0 && y < 0.0) g_colors.push([1.0,1.0,1.0, 1.0]) //white
    else g_colors.push([0.0,0.0,1.0, 1.0]) //blue 
    ...
    for(var i = 0; i < len; i++){
        ...
        // TODO: pass position of a point into shader to draw
        gl.uniform4f(u_Position, xy[0], xy[1], 0.0, 1.0);
        // TODO: pass color of a point into shader to draw
